...
public class RuntimePermissionUnits {
    private RuntimePermissionUnits() {
    }
    ...
    public static boolean shouldShowRequestPermissionRational(@NonNull Activity activity, @NonNull String permission) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
